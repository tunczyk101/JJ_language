...
class Function_specialization:
    ...
    @staticmethod
    def from_optional_function_blocks(
            optional_function_blocks: jjParser.Optinal_function_blocksContext) -> 'Function_specialization':
        return Function_specialization(optional_function_blocks.guard_block(),
                                       optional_function_blocks.structural_block(),
                                       optional_function_blocks.return_block())
...
class Function:
    ...
    def from_function_context(function_context: jjParser.FunctionContext) -> 'Function':
        ...
        specialisation = Function_specialization.from_optional_function_blocks(
            function_context.optinal_function_blocks())
...
def assert_fn(arg, ctx: jjParser.Function_callContext):
    if not arg:
        ...
        print(f"Assertion Error: Assertion {assertion_text} failed at {ctx.getSourceInterval}.")
        exit(0)
